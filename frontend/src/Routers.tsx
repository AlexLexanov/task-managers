...
const ProjectCreatePageLazy = lazy(() => import("./pages/Projects/ProjectCreatePage"))
...
export const Routers = () => {  
  ...
  return (
    <Routes>
      <Route 
        path="/"
        element={<ProtectedRoute toRedirect="/authorization" 
      ...
      <Route path="/authorization" element={<AuthorizationLayout />}>
        ...
        <Route path="sing_up" element={<SignUpPageLazy />} />
      </Route>
    </Routes>
  );
};
